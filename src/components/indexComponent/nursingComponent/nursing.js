                  ...
                  <Card className="hospital-card">
                    <div className="ui fluid image">
                      <img
                        ...
                        alt=""
                      />
                      <span className="hospital-header">Nursing-2</span>
                    </div>
                  </Card>
                </div>
            <div>
              <Card className="hospital-card">
                <div className="ui fluid image">
                  <img
                    ...
                    alt=""
                  />
                  <span className="hospital-header">Nursing-3</span>
                </div>
              </Card>
             </div>
             <div>
              <Card className="hospital-card">
                <div className="ui fluid image">
                  <img
                    ...
                    alt=""
                  />
                  <span className="hospital-header">Nursing-4</span>
                </div>
              </Card>
             </div>
             <div>
              <Card className="hospital-card">
                <div className="ui fluid image">
                  <img
                    ...
                    alt=""
                  />
                  <span className="hospital-header">Nursing-5</span>
                </div>
              </Card>
             </div>
             <div>
              <Card className="hospital-card">
                <div className="ui fluid image">
                  <img
                    ...
                    alt=""
                  />
                  <span className="hospital-header">Nursing-6</span>
                </div>
              </Card>
            </div>
          </Slider>
