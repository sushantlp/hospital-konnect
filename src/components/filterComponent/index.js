     ...
     <nav class="navbar" role="navigation" aria-label="main navigation">
       <div class="container">
         ...
         <div id="navbar-menu-id" class="navbar-menu">
                 ...
                 {object.amenities.map((obj, key) => {
                   ...
                   return (
                     <div class="field" key={key}>
                       <input class="is-checkradio" id={name} type="checkbox" name={name} style={{marginLeft:"1em"}} onChange={event => props.filterAmenitiesPush(event,obj)}/>
             ...
             <div class="navbar-item has-dropdown is-hoverable">
               ...
               <div class="navbar-dropdown">
                 {object.registration_charges.map((obj, key) => {
                   ...
                   return (
                     <div class="field" key={key}>
                       <input class="is-checkradio" id={name} type="checkbox" name={name} style={{marginLeft:"1em"}} onChange={event => props.filterPricesPush(event,obj)}/>
                       <label for={name} style={{marginLeft:"1em"}}>{obj.label}</label>
                     </div>
                   );
                 })}
           ...
           {props.price_checkbox.length === 0 && props.amenities_checkbox.length === 0 ? null : <div class="navbar-end"> <div class="navbar-item"><p class="subtitle is-4" style={{float:"right"}}> <a class="button" style={{backgroundColor:"#ff3860", color:"white"}}>CLEAR ALL</a></p> </div> </div> }
